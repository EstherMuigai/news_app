...
class SourceTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_source = ("abc-news","ABC News","Your trusted source for breaking news, analysis, exclusive interviews, headlines, and videos at ABCNews.com.","https://abcnews.go.com","general","en","us")
